...
export function ProfessionalStatusTodayCard({ title, professionals, isLoading, icon, emptyMessage = "No hay profesionales para mostrar.", locations }: ProfessionalStatusTodayCardProps) {
  return (
    <Card>
